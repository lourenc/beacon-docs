...
var monaco_editor_core = __webpack_require__(249);
...
var languageFeatures_DiagnosticsAdapter = /** @class */ (function (_super) {
    ...
    function DiagnosticsAdapter(_libFiles, _defaults, _selector, worker) {
        ...
        _this._disposables.push(monaco_editor_core["editor"].onDidCreateModel(onModelAdd));
        ...
        monaco_editor_core["editor"].getModels().forEach(onModelAdd);
        return _this;
    }
    ...
    DiagnosticsAdapter.prototype._convertRelatedInformation = function (model, relatedInformation) {
        ...
        relatedInformation.forEach(function (info) {
            ...
            if (info.file) {
                var relatedResourceUri = monaco_editor_core["Uri"].parse(info.file.fileName);
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        for (_i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
                            entry = entries_1[_i];
                            uri = monaco_editor_core["Uri"].parse(entry.fileName);
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        for (_i = 0, renameLocations_1 = renameLocations; _i < renameLocations_1.length; _i++) {
                            ...
                            resource_1 = monaco_editor_core["Uri"].parse(renameLocation.fileName);
                            model_1 = monaco_editor_core["editor"].getModel(resource_1);
                            if (model_1) {
                                edits.push({
                                    resource: resource_1,
                                    edit: {
...
function setupMode(defaults, modeId) {
    ...
    monaco_editor_core["languages"].registerRenameProvider(modeId, new languageFeatures_RenameAdapter(worker));
